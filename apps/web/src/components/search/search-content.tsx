...
import { LoaderIcon, SearchIcon, XIcon } from '@store/ui/icons';
import { ScrollArea, ScrollBar } from '@store/ui';

function useRecentSearches() {
  // TODO: add type later
  return useRecentSearchesStorage<any>();
}
...
function ProposedPhrases() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <button
        onClick={updateQuery('Steam Top Up')}
        className="focus-visible:ring-ring hover:bg-foreground/10 flex w-full flex-col items-start justify-center gap-2 overflow-hidden border-b p-6 transition-colors"
      >
        Steam Top Up
      </button>
      <button
        onClick={updateQuery('Dota 2 boost')}
        className="focus-visible:ring-ring hover:bg-foreground/10 flex w-full flex-col items-start justify-center gap-2 overflow-hidden border-b p-6 transition-colors"
      >
        Dota 2 boost
      </button>
