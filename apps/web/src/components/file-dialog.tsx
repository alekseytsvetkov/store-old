...
import { Button, Dialog, DialogContent, DialogTrigger, toast } from '@store/ui';
      ...
      if (rejectedFiles.length > 0) {
        rejectedFiles.forEach(({ errors }) => {
          if (errors[0]?.code === 'file-too-large') {
            toast({ title: `File is too large. Max size is ${formatBytes(maxSize)}` });
            return;
          }
          errors[0]?.message && toast({ title: errors[0].message });
        });
      }
    },
        ...
        >
          ...
          {isUploading ? (
            ...
            <div className="grid place-items-center gap-1 sm:px-5">
              <UploadIcon className="text-muted-foreground h-8 w-8" aria-hidden="true" />
            ...
            <DialogContent>
              ...
              <div className="mt-8 grid place-items-center space-y-5">
                ...
                <div className="flex items-center justify-center space-x-2">
                  ...
                  >
                    <ResetIcon className="mr-2 h-3.5 w-3.5" aria-hidden="true" />
                    Reset crop
                  </Button>
                </div>
              </div>
